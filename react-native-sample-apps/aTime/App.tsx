                ...
                <Storyly
                 ...
                 <Storyly
                  ...
                  <Storyly
                    ...
                    storyGroupTextSize={10}
                    storyGroupTextColorSeen="#ffffff"
                    storyGroupTextColorNotSeen="#000000"
                    storyGroupSize="custom"
                    storyGroupIconHeight={60}
                    storyGroupIconWidth={60}
                    storyGroupIconCornerRadius={30}
                    storyGroupListSections={1}
                    storyGroupListOrientation="horizontal"
                    storyGroupListHorizontalEdgePadding={20}
                    storyGroupListHorizontalPaddingBetweenItems={20}
                    storylyId={"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NfaWQiOjk2MjEsImFwcF9pZCI6MTQ1ODAsImluc19pZCI6MTU5MTJ9.dgaPNvH0eOVl1AIrmgDqzQ4AmMmgFFTfS4nJi9AOT4I"}
                  />
                <Button
